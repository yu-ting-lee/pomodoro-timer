...
from PyQt5.QtGui import QCloseEvent, QFont, QIcon, QKeyEvent, QPixmap
...
class GearWidget(QWidget):
    ...
    def initUI(self) -> None:
        ...
        label = QLabel('', self)
        label.setPixmap(QPixmap('figure/work.png').scaledToHeight(40))
        ...
        label = QLabel('', self)
        label.setPixmap(QPixmap('figure/short-break.png').scaledToHeight(40))
        ...
        label = QLabel('', self)
        label.setPixmap(QPixmap('figure/long-break.png').scaledToHeight(40))
        ...
        label = QLabel('', self)
        label.setPixmap(QPixmap('figure/alarm.png').scaledToHeight(40))
...
class RestWidget(QWidget):
    ...
    def __init__(self, parent: QWidget = None):
        super().__init__(parent)
        self.title = 'Short Rest' if timer.state == 'S' else 'Long Rest'
        self.locked = True
